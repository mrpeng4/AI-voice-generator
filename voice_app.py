...
class MultiVoiceApp:
    def __init__(self, root, voices):
        ...
        # Pre-populate the box with the user's favorite voices
        for short in self.favorites:
            if short in self.short_to_display:
                self.add_voice_to_use_box(preset_short=short)
